...
public class SearchCoursePage  {
    ...
    public static final Target BUTTON_UC = Target.the("seleccione la univerisdad choucair")
    ...
    public static final Target NAME_COURSE = Target.the("Extraer el nombre del curso").located(By.xpath("//h1[contans(text(),'Recurso Automatización Bancolombia')]"));
